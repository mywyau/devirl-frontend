        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
                ...
                <ul class="space-y-1">
                    ...
                    <li>
                        <NuxtLink to="/privacy-policy" class="hover:text-white hover:underline">Privacy Policy
                        </NuxtLink>
                    </li>
                    <li>
                        <NuxtLink to="/terms-and-conditions" class="hover:text-white hover:underline">Terms of Service
                        </NuxtLink>
                    </li>
                </ul>
            </div>
