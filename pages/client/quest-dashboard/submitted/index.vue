<template>
  <NuxtLayout>
    <div class="p-6 max-w-5xl mx-auto text-blue-400">
      ...
      <h1 class="text-3xl font-bold mb-8">Client Submitted Quests</h1>
      <p class="text-xl font-bold mb-8">
        Quests which a freelancer has submitted for review and payment
      </p>
...
const quests = [
  ...
  },
  {
    ...
    description:
      "Implement dark mode support across the entire frontend, including modals and dropdowns.",
    bounty: 0.2,
    status: "Submitted",
  },
  {
    ...
    description:
      "Fix layout issues on smaller screen sizes, especially for the dashboard and profile pages.",
    bounty: 0.15,
    status: "Submitted",
  },
  {
    ...
    description:
      "Implement lazy loading for large assets to improve page performance.",
    bounty: 0.18,
    status: "Submitted",
  },
];
