...
<template>
  <NuxtLayout>
    <div class="p-6 max-w-5xl mx-auto">
      <h1 class="text-3xl font-bold mb-4 text-zinc-200">Estimated</h1>
      <p class="text-lg mb-6 text-zinc-300/80">
        Below are all the quests that you have estimated. Only quests closed for estimation will show up here.
      </p>
      ...
      <div v-else class="text-zinc-400">You have not estimated any quests.</div>
    </div>
  </NuxtLayout>
</template>
